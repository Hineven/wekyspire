...
registerSkill({
  id: 'purify', name: '纯化', type: 'normal', tier: 'D',
...
registerSkill({
  id: 'deepPurify', name: '深度纯化', type: 'normal', tier: 'C',
  cost: { mana: 1, actionPoint: 0 },
  charges: { max: 1, cooldownTurns: 1 },
  cardMode: 'normal',
  use(sctx) {
...
registerSkill({
  id: 'extract', name: '萃取', type: 'normal', tier: 'C',
...
registerSkill({
  id: 'deepExtract', name: '深度萃取', type: 'normal', tier: 'B',
  cost: { mana: 3, actionPoint: 0 },
  charges: { max: 1, cooldownTurns: 1 },
  cardMode: 'normal',
  use(sctx) {
...
// 汲取（C）：1AP，冷却3：纳气2。
registerSkill({
  id: 'drawQi', name: '汲取', type: 'normal', tier: 'C',
...
// 压榨（B）：1AP，冷却3：纳气3。
registerSkill({
  id: 'squeezeQi', name: '压榨', type: 'normal', tier: 'B',
  cost: { mana: 0, actionPoint: 1 },
  charges: { max: 1, cooldownTurns: 3 },
  cardMode: 'normal',
  use(sctx) {
